...
--declare @Scope int      =0   --  0 All accounts
...
--Select Opening Balance Query
SELECT   
case @Scope when-1 then IIF(GLView_ChartOfAccounts.Parent1=0,GLView_ChartOfAccounts.Code,GLView_ChartOfAccounts.Parent1) when -2 then IIF(GLView_ChartOfAccounts.Parent2=0,GLView_ChartOfAccounts.Code,GLView_ChartOfAccounts.Parent2) when -3 then IIF(GLView_ChartOfAccounts.Parent3=0,GLView_ChartOfAccounts.Code,GLView_ChartOfAccounts.Parent3) when -4  then IIF(GLView_ChartOfAccounts.Parent4=0,GLView_ChartOfAccounts.Code,GLView_ChartOfAccounts.Parent4) when -5  then IIF(GLView_ChartOfAccounts.Parent5=0,GLView_ChartOfAccounts.Code,GLView_ChartOfAccounts.Parent5) when -6  then IIF(GLView_ChartOfAccounts.Parent6=0,GLView_ChartOfAccounts.Code,GLView_ChartOfAccounts.Parent6) when -7  then IIF(GLView_ChartOfAccounts.Parent7=0,GLView_ChartOfAccounts.Code,GLView_ChartOfAccounts.Parent7)  when -8  then IIF(GLView_ChartOfAccounts.Parent8=0,GLView_ChartOfAccounts.Code,GLView_ChartOfAccounts.Parent8) when -9  then IIF(GLView_ChartOfAccounts.Parent9=0,GLView_ChartOfAccounts.Code,GLView_ChartOfAccounts.Parent9)   else GLView_ChartOfAccounts.Code end as Code ,
...
WHERE  GL_DailyVoucher.CompanyId IN (@CompanyId) AND GL_DailyVoucher.BranchId IN (@BranchId) AND cast(GL_DailyVoucher_DTL.TransactDate_Gregi as date) < @FirstDate
GROUP BY GL_DailyVoucher_DTL.AccountId) AS DailyVoucher RIGHT OUTER JOIN
GLView_ChartOfAccounts ON DailyVoucher.AccountId = GLView_ChartOfAccounts.Id where GLView_ChartOfAccounts.CompanyId in(@CompanyId) and (GLView_ChartOfAccounts.Levels=ABS(@Scope) or  GLView_ChartOfAccounts.HasChildren=0)
...
FROM            GL_DailyVoucher INNER JOIN
                         GL_DailyVoucher_DTL ON GL_DailyVoucher.Id = GL_DailyVoucher_DTL.DailyVoucherId  INNER JOIN
                         GLView_ChartOfAccounts ON GL_DailyVoucher_DTL.AccountId = GLView_ChartOfAccounts.Id
WHERE        GL_DailyVoucher.CompanyId IN (@CompanyId) AND GL_DailyVoucher.BranchId IN (@BranchId) AND cast(GL_DailyVoucher_DTL.TransactDate_Gregi as date) between @FirstDate and @LastDate
 ...
 -- First insert account tree in temp table for performance 
--if OBJECT_ID('tempdb..GLView_ChartOfAccounts') is not null drop table GLView_ChartOfAccounts
--select * into GLView_ChartOfAccounts  from GLView_ChartOfAccounts
...
--Select Opening Balance Query
SELECT   
 GLView_ChartOfAccounts.Code  as Code ,
SUBSTRING (GLView_ChartOfAccounts.Code, 1, 1)   AccSort, GLView_ChartOfAccounts.NameA  as NameA ,GLView_ChartOfAccounts.NameE  as NameE ,
 isnull(DailyVoucher.FirstDebit,0) as FirstDebit, isnull(DailyVoucher.FirstCredit,0) as FirstCredit,0 as PeriodDebit,0 as PeriodCredit
FROM  (SELECT       GL_DailyVoucher_DTL.AccountId, 
case when SUM(ISNULL(GL_DailyVoucher_DTL.DebitLocal, 0))- SUM(ISNULL(GL_DailyVoucher_DTL.CreditLocal, 0)) > 0 then SUM(ISNULL(GL_DailyVoucher_DTL.DebitLocal, 0))- SUM(ISNULL(GL_DailyVoucher_DTL.CreditLocal, 0))  else 0 end AS FirstDebit,
case when SUM(ISNULL(GL_DailyVoucher_DTL.CreditLocal, 0))- SUM(ISNULL(GL_DailyVoucher_DTL.DebitLocal, 0)) > 0 then SUM(ISNULL(GL_DailyVoucher_DTL.CreditLocal, 0))-SUM(ISNULL(GL_DailyVoucher_DTL.DebitLocal, 0)) else 0 end AS FirstCredit
...
WHERE  GL_DailyVoucher.CompanyId IN (@CompanyId) AND GL_DailyVoucher.BranchId IN (@BranchId) AND cast(GL_DailyVoucher_DTL.TransactDate_Gregi as date) < @FirstDate
GROUP BY GL_DailyVoucher_DTL.AccountId) AS DailyVoucher RIGHT OUTER JOIN
GLView_ChartOfAccounts ON DailyVoucher.AccountId = GLView_ChartOfAccounts.Id where GLView_ChartOfAccounts.CompanyId in(@CompanyId) and  GLView_ChartOfAccounts.HasChildren=0 
and cast(GLView_ChartOfAccounts.Parent1 as numeric) between IIf(@level=1, @AccCode,-88888888888888888888888888) and IIf(@level=1, @AccCode,88888888888888888888888888) 
and cast(GLView_ChartOfAccounts.Parent2 as numeric) between IIf(@level=2, @AccCode,-88888888888888888888888888) and IIf(@level=2, @AccCode,88888888888888888888888888) 
and cast(GLView_ChartOfAccounts.Parent3 as numeric) between IIf(@level=3, @AccCode,-88888888888888888888888888) and IIf(@level=3, @AccCode,88888888888888888888888888) 
and cast(GLView_ChartOfAccounts.Parent4 as numeric) between IIf(@level=4, @AccCode,-88888888888888888888888888) and IIf(@level=4, @AccCode,88888888888888888888888888) 
and cast(GLView_ChartOfAccounts.Parent5 as numeric) between IIf(@level=5, @AccCode,-88888888888888888888888888) and IIf(@level=5, @AccCode,88888888888888888888888888) 
and cast(GLView_ChartOfAccounts.Parent6 as numeric) between IIf(@level=6, @AccCode,-88888888888888888888888888) and IIf(@level=6, @AccCode,88888888888888888888888888) 
and cast(GLView_ChartOfAccounts.Parent7 as numeric) between IIf(@level=7, @AccCode,-88888888888888888888888888) and IIf(@level=7, @AccCode,88888888888888888888888888) 
and cast(GLView_ChartOfAccounts.Parent8 as numeric) between IIf(@level=8, @AccCode,-88888888888888888888888888) and IIf(@level=8, @AccCode,88888888888888888888888888) 
and cast(GLView_ChartOfAccounts.Parent9 as numeric) between IIf(@level=9, @AccCode,-88888888888888888888888888) and IIf(@level=9, @AccCode,88888888888888888888888888) 
